...
#ifndef GENERATEDSAXPARSER_STATIC
#  if defined(_MSC_VER) || defined(__BORLANDC__)
#    pragma warning( disable: 4275 4251 )
#    ifdef GENERATEDSAXPARSER_EXPORT_API
#      define _GENERATEDSAXPARSER_API    __declspec( dllexport )
#    else
#      define _GENERATEDSAXPARSER_API    __declspec( dllimport )
#    endif
#  else // defined(__GNUC__) || defined(__APPLE__) or other unix
#    define _GENERATEDSAXPARSER_API __attribute__((visibility("default")))
#  endif
#else
#  define _GENERATEDSAXPARSER_API
#endif
