...
namespace COLLADASW
{
    ...
    class _COLLADASW_API Light : public ElementWriter, public BaseExtraTechnique
    {
    public:
...
//         String mDropOffSid;
    ...
    class _COLLADASW_API AmbientLight : public Light
    {
    public:
    ...
    class _COLLADASW_API DirectionalLight : public Light
    {
    public:
    ...
    class _COLLADASW_API PointLight : public Light
    {
    public:
    ...
    class _COLLADASW_API SpotLight : public Light
    {
    public:
