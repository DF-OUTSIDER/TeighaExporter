...
namespace COLLADASW
{
    ...
    class _COLLADASW_API PrimitivesBase : public ElementWriter
    {
     ...
     */
    class _COLLADASW_API Polygons : public PrimitivesBase
    {
    public:
    ...
    * Class for the polygons element.
    */
    class _COLLADASW_API VertexWeightsElement : public PrimitivesBase
    {
    public:
	...
	*/
	class _COLLADASW_API Linestrips : public PrimitivesBase
	{
	public:
	...
	*/
	class _COLLADASW_API Trifans : public PrimitivesBase
	{
	public:
	...
	*/
	class _COLLADASW_API Tristrips : public PrimitivesBase
	{
	public:
