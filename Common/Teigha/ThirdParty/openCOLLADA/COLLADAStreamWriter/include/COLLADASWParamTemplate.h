...
namespace COLLADASW
{
    ...
    private:
        ...
        String& getModifierString ( const Modifier& modifier )
        {
            switch ( modifier )
            {
            case MODI_CONST: return (const_cast<String&>(CSWC::CSW_MODIFIER_CONST));
            case MODI_UNIFORM: return (const_cast<String&>(CSWC::CSW_MODIFIER_UNIFORM));
            case MODI_VARYING: return (const_cast<String&>(CSWC::CSW_MODIFIER_VARYING));
            case MODI_STATIC: return (const_cast<String&>(CSWC::CSW_MODIFIER_STATIC));
            case MODI_VOLATILE: return (const_cast<String&>(CSWC::CSW_MODIFIER_VOLATILE));
            case MODI_EXTERN: return (const_cast<String&>(CSWC::CSW_MODIFIER_EXTERN));
            case MODI_SHARED: return (const_cast<String&>(CSWC::CSW_MODIFIER_SHARED));
            default: return (const_cast<String&>(CSWC::EMPTY_STRING));
            }
        }
