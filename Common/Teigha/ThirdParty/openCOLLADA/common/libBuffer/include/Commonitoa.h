...
namespace Common
{
	...
	_LIBBUFFER_API size_t itoa( signed char value       , char* buffer, unsigned char radix);
	_LIBBUFFER_API size_t itoa( unsigned char value     , char* buffer, unsigned char radix);
	_LIBBUFFER_API size_t itoa( signed short value      , char* buffer, unsigned char radix);
	_LIBBUFFER_API size_t itoa( unsigned short value    , char* buffer, unsigned char radix);
	_LIBBUFFER_API size_t itoa( signed int value        , char* buffer, unsigned char radix);
	_LIBBUFFER_API size_t itoa( unsigned int value      , char* buffer, unsigned char radix);
	_LIBBUFFER_API size_t itoa( signed long value       , char* buffer, unsigned char radix);
	_LIBBUFFER_API size_t itoa( unsigned long value     , char* buffer, unsigned char radix);
	_LIBBUFFER_API size_t itoa( signed long long value  , char* buffer, unsigned char radix);
	_LIBBUFFER_API size_t itoa( unsigned long long value, char* buffer, unsigned char radix);
