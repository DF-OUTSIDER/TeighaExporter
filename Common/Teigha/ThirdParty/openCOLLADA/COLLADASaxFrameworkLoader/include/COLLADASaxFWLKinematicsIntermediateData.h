...
namespace COLLADASaxFWL
{
	...
	class _COLLADASAXFWL_API KinematicsModel: public IntermediateTargetableTemplate<INTERMEDIATETARGETABLE_TYPE::KINEMATICMODEL>
	{
	private:
...
//		void setValueType(ValueType valueType) { mValueType = valueType; }
    ...
    typedef COLLADABU_HASH_MAP<String/*sid*/,KinematicsNewParam*> KinematicsNewParams;
#else
	...
	class _COLLADASAXFWL_API KinematicsBind
	{
	public:
	...
	class _COLLADASAXFWL_API KinematicsScene: public IntermediateTargetableTemplate<INTERMEDIATETARGETABLE_TYPE::KINEMATICSCENE>
	{
	private:
	...
	/** Bind as it appears in kinematics */
	class _COLLADASAXFWL_API KinematicsSidrefOrParam
	{
	public:
	...
	/** Bind as it appears in kinematics */
	class _COLLADASAXFWL_API KinematicsFloatOrParam
	{
	public:
	...
	class _COLLADASAXFWL_API KinematicsBindJointAxis
	{
	private:
	...
	class _COLLADASAXFWL_API KinematicsInstanceKinematicsScene
	{
	private:
	...
	class _COLLADASAXFWL_API KinematicsIntermediateData 	
	{
	public:
		/** List of Joints.*/
