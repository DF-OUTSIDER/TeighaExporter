...
#ifndef COLLADASAXFWL_STATIC
#  if defined(_MSC_VER) || defined(__BORLANDC__)
#    pragma warning( disable: 4275 4251 )
#    ifdef  COLLADASAXFWL_EXPORT_API
#      define _COLLADASAXFWL_API    __declspec( dllexport )
#    else
#      define _COLLADASAXFWL_API    __declspec( dllimport )
#    endif
#  else // defined(__GNUC__) || defined(__APPLE__) or other unix
#    define _COLLADASAXFWL_API __attribute__((visibility("default")))
#  endif
#else
#  define _COLLADASAXFWL_API
#endif //COLLADASAXFWL_STATIC
