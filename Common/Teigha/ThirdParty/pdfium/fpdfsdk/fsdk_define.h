...
FPDF_EXPORT CPDF_Document* FPDF_CALLCONV CPDFDocumentFromFPDFDocument(FPDF_DOCUMENT doc);
FPDF_DOCUMENT FPDFDocumentFromCPDFDocument(CPDF_Document* doc);

FPDF_EXPORT CPDF_Page* FPDF_CALLCONV CPDFPageFromFPDFPage(FPDF_PAGE page);

CPDF_PathObject* CPDFPathObjectFromFPDFPageObject(FPDF_PAGEOBJECT page_object);

FPDF_EXPORT CPDF_PageObject* FPDF_CALLCONV CPDFPageObjectFromFPDFPageObject(FPDF_PAGEOBJECT page_object);
...
FPDF_EXPORT void FPDF_CALLCONV FPDF_RenderPage_Retail(CPDF_PageRenderContext* pContext,
                                                      FPDF_PAGE page,
                                                      int start_x,
                                                      int start_y,
                                                      int size_x,
