...
#ifndef _DWFTK_PACKAGE_VERSION_EXTENSION_6_20_H
#define _DWFTK_PACKAGE_VERSION_EXTENSION_6_20_H


///
///\file        dwf/package/writer/extensions/6.20/PackageVersionExtension.h
///\brief       This file contains the DWFPackageVersionExtension class declaration for <b>DWF 6.20 File Format</b>.
///
...
///\ingroup     dwfpackage
///
///\class       DWFPackageVersion620Extension   dwf/package/writer/extensions/6.20/PackageVersionExtension.h     "dwf/package/writer/extensions/6.20/PackageVersionExtension.h"
///\brief       This is the <b>DWF 6.20 File Format</b> plug-in for the DWFPackageWriter.
///\since       7.1.0
///
///             The current DWF Format version is 6.21. This version extension allows
///             DWF 6.20 files to be created. DWF 6.20 files can have any number of ePlot
///             and eModel sections as well as Content of Content Presentation data, but
///             don't have graphical markup of EModel sections.
///             
///
class DWFPackageVersion620Extension : public DWF6PackageVersionExtension
...
public:
    ...
    ///
    _DWFTK_API
    DWFPackageVersion620Extension( const DWFString& zDocumentType )
        throw();
    ...
    /// 
    _DWFTK_API
    virtual ~DWFPackageVersion620Extension()
        throw();
    ...
    unsigned short minor_version()
        throw()
    {
        return _DWF_FORMAT_VERSION_CONTENT_DEFINITION_MINOR;
    }
#else
    _DWFTK_API
