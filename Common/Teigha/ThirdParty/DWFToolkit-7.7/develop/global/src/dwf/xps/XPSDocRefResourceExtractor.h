...
#ifndef _DWFTK_XPSDocRefResourceExtractor_H
#define _DWFTK_XPSDocRefResourceExtractor_H
...
///\ingroup     dwfx
///
///\class       XPSDocRefResourceExtractor   dwf/dwfx/reader/FixedPageResourceExtractor.h     "dwf/dwfx/reader/FixedPageResourceExtractor.h"
///\brief       This class implements extraction of DWF resources contained within a Fixed Page part
///\since       7.4.0
///
///

class XPSDocRefResourceExtractor : public DWFCore::DWFXMLCallback
                             _DWFTK_EXPORT_API_MEMORY_CONTROL_BASE_MEMBER
{
public:
    _DWFTK_API
    XPSDocRefResourceExtractor( DWFInputStream* pInputStream, bool bOwnStream )
        throw( DWFException );
    
    _DWFTK_API
    virtual ~XPSDocRefResourceExtractor()
        throw();
