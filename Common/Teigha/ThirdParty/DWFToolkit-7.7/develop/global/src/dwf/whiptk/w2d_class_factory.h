...
//
#if !defined WHIP_CLASSFACTORY_HEADER
#define WHIP_CLASSFACTORY_HEADER
...
class WHIPTK_API WT_W2D_Class_Factory : public WT_Class_Factory
{
public:
    ...
    ///
    virtual WT_Attribute_URL*		Create_Attribute_URL(WT_Attribute &attribute, WT_URL_Item &item) throw(DWFException);
	///
    ...
    ///
	virtual WT_Contrast_Color* Create_Contrast_Color( const WT_Contrast_Color& color  ) 
        throw(DWFException);

	//Compressed_Data_Moniker
	///
    ///\copydoc WT_Class_Factory::Create_Compressed_Data_Moniker(int format=REVISION_WHEN_ZLIB_COMPRESSION_IS_SUPPORTED) 
    ///
	virtual WT_Compressed_Data_Moniker*		Create_Compressed_Data_Moniker(int format=REVISION_WHEN_ZLIB_COMPRESSION_IS_SUPPORTED) 
		throw(DWFException);
	...
	//Dash_Pattern_List
	///
    ///\copydoc WT_Class_Factory::Create_Dash_Pattern_List() 
    ///
	virtual WT_Dash_Pattern_List*	Create_Dash_Pattern_List() 
        throw(DWFException);
    ///
    ///\copydoc WT_Class_Factory::Create_Dash_Pattern_List(WT_Dash_Pattern* pPat) 
    ///
	...
	//FileTime
	///
    /// WT_Class_Factory::Create_FileTime() 
    /// create WT_FileTime object
    ///
	virtual WT_FileTime*				Create_FileTime() 
        throw(DWFException);
	///
    /// WT_Class_Factory::Create_FileTime(const WT_Unsigned_Integer32 & low_date_time,const WT_Unsigned_Integer32 & high_date_time) 
    /// create WT_FileTime object with given parameters
    ///
	virtual WT_FileTime*				Create_FileTime(const WT_Unsigned_Integer32 & low_date_time, 
	...
	//Font
	///
    ///\copydoc WT_Class_Factory::Create_Font(WT_Font const& font) 
    ///
	...
	virtual WT_Font_Extension*			Create_Font_Extension() 
        throw(DWFException);
 	///
    ///\copydoc WT_Class_Factory::Create_Font_Extension(WT_String const & logfont_name, WT_String const & cannonical_name) 
    ///
	...
	virtual WT_Layer*					Create_Layer() 
        throw(DWFException);
 	///
    ///\copydoc WT_Class_Factory::Create_Layer(WT_File & /*file*/, WT_Integer32 /*layer_num*/, char const * /*layer_name*/=WD_Null) 
	///
	...
	///
 	virtual WT_Named_View*				Create_Named_View(WT_Named_View const &named_view) 
		throw(DWFException);
 	///
	///\copydoc WT_Class_Factory::Create_Named_View(WT_Logical_Box const &view, const char *name=WD_Null) 
	///
	...
	//WT_Object_Stream
	///
	///\copydoc WT_Class_Factory::Create_Object_Stream() 
	///
	...
	//WT_Object_Stream
	///
	///\copydoc WT_Class_Factory::Create_Object_Stream(WT_Object_Stream const& object_stream) 
	///
	...
	//WT_Orientation
	///
	/// WT_Class_Factory::Create_Orientation() 
    /// \return WT_Orientation object
	///
	virtual WT_Orientation*				Create_Orientation() 
        throw(DWFException);
	...
	//PenPat_Options
	///
	///\copydoc WT_Class_Factory::Create_PenPat_Options() 
	///
	virtual WT_PenPat_Options*			Create_PenPat_Options() 
        throw(DWFException);
 	///
	///\copydoc WT_Class_Factory::Create_PenPat_Options(WT_Boolean const scale_pen_width, 
	...
	///
 	virtual WT_PenPat_Options*			Create_PenPat_Options(WT_Boolean const scale_pen_width, 
																 ...
																 throw(DWFException);
 	///
	///\copydoc WT_Class_Factory::Create_PenPat_Options(WT_PenPat_Options const &other) 
	///
 	virtual WT_PenPat_Options*			Create_PenPat_Options(WT_PenPat_Options const &other) 
        throw(DWFException);

	///
	///\copydoc WT_Class_Factory::Create_Plot_Optimized() 
	///
	virtual WT_Plot_Optimized*			Create_Plot_Optimized() 
        throw(DWFException);
 	///
	///\copydoc WT_Class_Factory::Create_Plot_Optimized(WT_Boolean plot_optimized) 
	///
 	virtual WT_Plot_Optimized*			Create_Plot_Optimized(WT_Boolean plot_optimized) 
        throw(DWFException);
	///
	///\copydoc WT_Class_Factory::Create_Plot_Optimized(WT_Plot_Optimized const& plot_optimized) 
	///
	...
	///
	///\copydoc WT_Class_Factory::Create_Units(WT_Units const& u) 
	///
	...
	//URL_List
	///
	///\copydoc WT_Class_Factory::Create_URL_List() 
	///
	virtual WT_URL_List*				Create_URL_List() 
        throw(DWFException);
 	///
	///\copydoc WT_Class_Factory::Create_URL_List(WT_URL_List const &list) 
	///
...
#endif //WHIP_CLASSFACTORY_HEADER
