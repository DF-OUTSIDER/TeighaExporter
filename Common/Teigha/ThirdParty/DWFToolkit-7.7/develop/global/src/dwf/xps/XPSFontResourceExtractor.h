...
#ifndef _DWFTK_XPSFontResourceExtractor_H
#define _DWFTK_XPSFontResourceExtractor_H
...
///\ingroup     dwfx
///
///\class       XPSFontResourceExtractor   dwf/dwfx/reader/FixedPageResourceExtractor.h     "dwf/dwfx/reader/FixedPageResourceExtractor.h"
///\brief       This class implements extraction of DWF resources contained within a Fixed Page part
///\since       7.4.0
///
///

class XPSFontResourceExtractor : public DWFCore::DWFXMLCallback
                             _DWFTK_EXPORT_API_MEMORY_CONTROL_BASE_MEMBER
{
public:
    _DWFTK_API
    XPSFontResourceExtractor( DWFInputStream* pInputStream, bool bOwnStream )
        throw( DWFException );
    
    _DWFTK_API
    virtual ~XPSFontResourceExtractor()
        throw();
