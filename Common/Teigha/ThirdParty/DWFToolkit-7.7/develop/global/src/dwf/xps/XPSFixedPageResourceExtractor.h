...
#ifndef _DWFTK_XPSFixedPageResourceExtractor_H
#define _DWFTK_XPSFixedPageResourceExtractor_H
...
///\ingroup     dwfx
///
///\class       XPSFixedPageResourceExtractor   dwf/dwfx/reader/FixedPageResourceExtractor.h     "dwf/dwfx/reader/FixedPageResourceExtractor.h"
///\brief       This class implements extraction of DWF resources contained within a Fixed Page part
///\since       7.4.0
///
///

class XPSFixedPageResourceExtractor : public DWFCore::DWFXMLCallback
                             _DWFTK_EXPORT_API_MEMORY_CONTROL_BASE_MEMBER
{
public:
    _DWFTK_API
    XPSFixedPageResourceExtractor( DWFInputStream* pInputStream, bool bOwnStream )
        throw( DWFException );
    
    _DWFTK_API
    virtual ~XPSFixedPageResourceExtractor()
        throw();
    ...
    ///
    _DWFTK_API
    DWFInputStream* getResourceStream()
        throw( DWFException );
