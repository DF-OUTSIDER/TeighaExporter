...
//
//  $Header: //DWF/Development/Components/Internal/DWF Toolkit/v7.7/develop/global/src/dwf/package/reader/SignatureSectionDescriptorReader.h#1 $
...
#ifndef _DWFTK_SIGNATURE_SECTION_DESCRIPTOR_READER_H
#define _DWFTK_SIGNATURE_SECTION_DESCRIPTOR_READER_H

///
///\file        dwf/package/reader/SignatureSectionDescriptorReader.h
///\brief       This file contains the DWFSignatureSectionDescriptorReader class declaration.
///
...
///\ingroup     dwfpackage
///
///\class       DWFSignatureSectionDescriptorReader   dwf/package/reader/SignatureSectionDescriptorReader.h     "dwf/package/reader/SignatureSectionDescriptorReader.h"
///\brief       This class implements the required XML parsing handlers to
///             compose toolkit objects from Signature section descriptor documents and
///             provide them via the typed callbacks.
///\since       7.2
///
///             This class contains the processing logic particular to the known versions 
///             of the Signature section descriptor.xml documents.  The algorithm is tuned specifically for these
...
///                                                     are created.  The DWFSignatureSection and DWFSignatureGlobalSection
...
///             
///             The actual parsing logic can be constained though the use of the \a DWFSignatureSectionDescriptorReader::teProviderType flags.
///
class DWFSignatureSectionDescriptorReader : public DWFSectionDescriptorReader
...
public:
    ...
    typedef enum
    {
        ...
        ///
        ///     Invoke the \a provideSignatureResource() element callback.
        ///
        eProvideSignatureResource           =   0x080,

        ///
        ///     Equivalent to (eProvideName | eProvideVersion | eProvideObjectID)
        ///
        eProvideAttributes                  =   0x007,
        
        ///
        ///     Equivalent to (eProvideProperties | eProvideResources | eProvideUntypedResource | eProvideSignatureResource)
        ///
        eProvideElements                    =   0x0F0,
...
public:
    ...
    ///
    _DWFTK_API
    DWFSignatureSectionDescriptorReader( DWFPackageReader*  pPackageReader = NULL,
    ...
    ///
    _DWFTK_API
    virtual ~DWFSignatureSectionDescriptorReader()
        throw();
    ...
    ///
    _DWFTK_API
    void setFilter( DWFSignatureSectionDescriptorReader* pFilter )
        throw();
    ...
    ///
    _DWFTK_API
    virtual DWFSignatureResource* provideSignatureResource( DWFSignatureResource* pResource )
        throw();
...
private:
    ...
    void _provideSignatureResource( DWFSignatureResource* pResource )
        throw();
...
private:
    ...
    DWFSignatureSectionDescriptorReader* _pFilter;
...
private:
    ...
    DWFSignatureSectionDescriptorReader( const DWFSignatureSectionDescriptorReader& );
    DWFSignatureSectionDescriptorReader& operator=( const DWFSignatureSectionDescriptorReader& );
};
