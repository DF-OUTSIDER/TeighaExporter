...
#define unzStringFileNameCompare            ODA_DWF_RENAME_LOCAL_ZIP(unzStringFileNameCompare)
#define unzClose                            ODA_DWF_RENAME_LOCAL_ZIP(unzClose)
#define unzGetGlobalInfo                    ODA_DWF_RENAME_LOCAL_ZIP(unzGetGlobalInfo)
#define unzGetGlobalComment                 ODA_DWF_RENAME_LOCAL_ZIP(unzGetGlobalComment)
#define unzGoToFirstFile                    ODA_DWF_RENAME_LOCAL_ZIP(unzGoToFirstFile)
#define unzGoToNextFile                     ODA_DWF_RENAME_LOCAL_ZIP(unzGoToNextFile)
#define unzLocateFile                       ODA_DWF_RENAME_LOCAL_ZIP(unzLocateFile)
#define unzOpenCurrentFile                  ODA_DWF_RENAME_LOCAL_ZIP(unzOpenCurrentFile)
#define unzCloseCurrentFile                 ODA_DWF_RENAME_LOCAL_ZIP(unzCloseCurrentFile)
#define unzReadCurrentFile                  ODA_DWF_RENAME_LOCAL_ZIP(unzReadCurrentFile)
#define unztell                             ODA_DWF_RENAME_LOCAL_ZIP(unztell)
#define unzeof                              ODA_DWF_RENAME_LOCAL_ZIP(unzeof)
#define unzGetLocalExtrafield               ODA_DWF_RENAME_LOCAL_ZIP(unzGetLocalExtrafield)
#define unzClose                            ODA_DWF_RENAME_LOCAL_ZIP(unzClose)
#define unzGetGlobalInfo                    ODA_DWF_RENAME_LOCAL_ZIP(unzGetGlobalInfo)
#define unzGetGlobalComment                 ODA_DWF_RENAME_LOCAL_ZIP(unzGetGlobalComment)
#define unzGoToFirstFile                    ODA_DWF_RENAME_LOCAL_ZIP(unzGoToFirstFile)
#define unzGoToNextFile                     ODA_DWF_RENAME_LOCAL_ZIP(unzGoToNextFile)
#define unzLocateFile                       ODA_DWF_RENAME_LOCAL_ZIP(unzLocateFile)
#define unzGetCurrentFileInfo               ODA_DWF_RENAME_LOCAL_ZIP(unzGetCurrentFileInfo)
#define unzOpenCurrentFile                  ODA_DWF_RENAME_LOCAL_ZIP(unzOpenCurrentFile)
#define unzCloseCurrentFile                 ODA_DWF_RENAME_LOCAL_ZIP(unzCloseCurrentFile)
#define unzReadCurrentFile                  ODA_DWF_RENAME_LOCAL_ZIP(unzReadCurrentFile)
#define unztell                             ODA_DWF_RENAME_LOCAL_ZIP(unztell)
