...
// ==========================================================
#if !(defined(ANDROID) && !defined(ANDROID_NDK_CRYSTAX))
#include <math.h>
#include <stdlib.h> 
#include <memory.h>
#include <stdio.h>
...
//   Utility functions
// ==========================================================
#if !defined(_WIN32) || defined(__BCPLUSPLUS__) || defined(__BORLANDC__)
...
#endif // !defined(_WIN32) || defined(__BCPLUSPLUS__) || defined(__BORLANDC__)
...
// In MSVC 2003 this function is not exported from MDd library
// http://thedailyreviewer.com/dotnet/view/byteswap-functions-missing-in-crt-multithreaded-debug-dll-109250800
#if defined(_MSC_VER) && (_MSC_VER > 1310 || ((_MSC_VER == 1310) && !(defined(_DLL) && defined(_DEBUG))))
