...
#ifndef _ODDG_TRANSACTIONREACTOR_INCLUDED_
#define _ODDG_TRANSACTIONREACTOR_INCLUDED_
...
/** \details
    ...
    <group OdDb_Classes>
*/
class TG_EXPORT OdDgTransactionReactor : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdDgTransactionReactor);
  ...
  */
  ...
  /** \details
    ...
    So this function will be called only once in OdDgElement::swapIdWith() method.
  */
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdDgTransactionReactor object pointers.
*/
typedef OdSmartPtr<OdDgTransactionReactor> OdDgTransactionReactorPtr;

#include "TD_PackPop.h"

#endif // _ODDG_TRANSACTIONREACTOR_INCLUDED_
