...
#ifndef   _ODDGED_H_INCLUDED_
#define   _ODDGED_H_INCLUDED_
...
#define ODDG_EDITOR_OBJ OD_T("OdDgEditor")
...
/** \details
    ...
    <group Other_Classes>
*/
class TG_EXPORT OdDgEditorReactor : public OdDgRxEventReactor 
{ 
public:
  ODRX_DECLARE_MEMBERS(OdDgEditorReactor);
  ...
  */
  ...
  /** \details
    Notification function called whenever an Element ID in an Xref database has been
    modified to point at an associated object in a host database. 
    
    \param oldId [in]  Element Id in the Xref database.
    \param neId [in]  Element Id in the host database.
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Rather than copy an Xref dependent element to the host database, the Element ID of the element
  ...
  */
  ...
  enum DgXrefSubcommandActivities
  {    
    kStart = 0,
    kStartItem = 2,
    kEndItem = 3,
  ...
  /** \details
    ...
    \param blockId [in]   Element ID of the Xref.
  ...
  */
  virtual void xrefSubcommandPathItem(
    int activity, OdDgElementId blockId, 
  ...
  */
  ...
  /** \details
    ...
    \param newModelName [in]  New model name.  
  */
  virtual void layoutSwitched(
    const OdString& newModelName);
  ...
  */
  ...
  /** \details
    ...
    \param objectIDs [in]  Element IDs lazy loaded.
  */
      virtual void objectsLazyLoaded(const OdDgElementIdArray& objectIds);
  ...
  */
  ...
  virtual void sysVarChanged(OdDgDatabase* pDb, const OdString& varName);
  
  virtual void sysVarWillChange(OdDgDatabase* pDb, const OdString& varName);
};

/** \details
    This template class is a specialization of the OdSmartPtr class for OdDgEditorReactor object pointers.
*/
typedef OdSmartPtr<OdDgEditorReactor> OdDgEditorReactorPtr;
...
/** \details
    ...
    <group Other_Classes>
*/
class TG_EXPORT OdDgEditor : public OdDgRxEvent 
{ 
public:
  ODRX_DECLARE_MEMBERS(OdDgEditor);
};

/** \details
This template class is a specialization of the OdSmartPtr class for OdDgEditor object pointers.
*/
typedef OdSmartPtr<OdDgEditor> OdDgEditorPtr;

TG_EXPORT OdDgEditorPtr oddgRxEditor();

#include "TD_PackPop.h"

#endif // _ODDGED_H_INCLUDED_
