...
#ifndef __OD_RADIAL_DIM_LARGE_RECOMPUTOR__
#define __OD_RADIAL_DIM_LARGE_RECOMPUTOR__
...
*/
class OdRadialDimLargeRecomputor : public OdDimRecomputor
{
public:
...
protected:
  OdRadialDimLargeRecomputor();
  virtual ~OdRadialDimLargeRecomputor();
  ...
  void formatDimStrWithLimsAndTols(OdString& formattedString, bool hasLimits, bool hasTols,
...
/** \details
  This class implements a Large Radial Dimension Block Recomputor Protocol Extension.
  Library: Source provided.
  <group RecomputeDimBlock_Classes> 
*/
class OdDbRadialDimLargeRecomputePEImpl : public OdDbDimRecomputePEImpl
{
protected:
...
#endif // __OD_RADIAL_DIM_LARGE_RECOMPUTOR__
