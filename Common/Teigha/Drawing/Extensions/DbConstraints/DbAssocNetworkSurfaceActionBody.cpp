...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ODRX_DEFINE_MEMBERS_EX(OdDbAssocNetworkSurfaceActionBody,      // ClassName
	...
	1025,                          // nProxyFlags 
	L"AcDbAssocNetworkSurfaceActionBody",   // DWG class name
	L"ACDBASSOCNETWORKSURFACEACTIONBODY",   // DxfName
											 //L"ACDBASSOCROTATEDDIMACTIONBODY",   // DWG class name
	L"ObjectDBX Classes",         // AppName
	OdRx::kMTLoading | OdRx::kHistoryAware);

OdDbAssocNetworkSurfaceActionBody::OdDbAssocNetworkSurfaceActionBody(bool bCreateImpl)
{
	if (bCreateImpl)
		m_pImpObj = static_cast<OdDbImpAssocActionBody*>(new OdDbImpAssocNetworkSurfaceActionBody());
	else
		m_pImpObj = NULL;
}

OdDbAssocNetworkSurfaceActionBody::~OdDbAssocNetworkSurfaceActionBody()
{
