...
#include "DbAssocEdgeChamferActionBody.h"

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ODRX_DEFINE_MEMBERS_EX(OdDbAssocEdgeChamferActionBody,      // ClassName
	...
	1025,                          // nProxyFlags 
	L"AcDbAssocEdgeChamferActionBody",   // DWG class name
	L"ACDbAssocEDGECHAMFERACTIONBODY",   // DxfName
	L"ObjectDBX Classes",         // AppName
	OdRx::kMTLoading | OdRx::kHistoryAware);

OdDbAssocEdgeChamferActionBody::OdDbAssocEdgeChamferActionBody(bool bCreateImpl)
{
	//if (bCreateImpl)
...
OdDbAssocEdgeChamferActionBody::~OdDbAssocEdgeChamferActionBody()
{
