...
///////////////////////////////////////////////////////////////////////////////
#ifndef OdDbAssocCirclePersSubentIdPE_INCLUDED_
#define OdDbAssocCirclePersSubentIdPE_INCLUDED_  /*!DOM*/
...
/** \details
  This class provides the base protocol extension class that declares 
  the protocol for working with circle persistent subentity identifier.

  Library: Source code provided.
  <group Contraint_Classes> 
*/
class DBCONSTRAINTS_EXPORT OdDbAssocCirclePersSubentIdPE : public OdDbAssocCurvePersSubentIdPE
{
public:
  ODRX_DECLARE_MEMBERS(OdDbAssocCirclePersSubentIdPE);
...
private:
  ...
  */
  bool checkSubentId(const OdDbSubentId& subentId, const OdDb::SubentType type) const;
};
