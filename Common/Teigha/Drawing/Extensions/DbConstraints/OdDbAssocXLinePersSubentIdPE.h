...
///////////////////////////////////////////////////////////////////////////////
#ifndef OdDbAssocXLinePersSubentIdPE_INCLUDED_
#define OdDbAssocXLinePersSubentIdPE_INCLUDED_  /*!DOM*/
...
/** \details
  ...
  working with infinity line persistent subentity identifier.

  Library: Source code provided.
  <group Contraint_Classes> 
*/
class DBCONSTRAINTS_EXPORT OdDbAssocXLinePersSubentIdPE : public OdDbAssocCurvePersSubentIdPE
{
public:
  ODRX_DECLARE_MEMBERS(OdDbAssocXLinePersSubentIdPE);
...
private:
  /** \details
    Checks the subentity identifier.
  */
