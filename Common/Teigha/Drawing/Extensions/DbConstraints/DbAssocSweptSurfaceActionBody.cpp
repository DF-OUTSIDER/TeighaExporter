...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ODRX_DEFINE_MEMBERS_EX(OdDbAssocSweptSurfaceActionBody,      // ClassName
	...
	1025,                          // nProxyFlags 
	L"AcDbAssocSweptSurfaceActionBody",   // DWG class name
	L"ACDBASSOCSWEPTSURFACEACTIONBODY",   // DxfName
											 //L"ACDBASSOCROTATEDDIMACTIONBODY",   // DWG class name
	L"ObjectDBX Classes",         // AppName
	OdRx::kMTLoading | OdRx::kHistoryAware);

OdDbAssocSweptSurfaceActionBody::OdDbAssocSweptSurfaceActionBody(bool bCreateImpl)
{
	if (bCreateImpl)
		m_pImpObj = static_cast<OdDbImpAssocActionBody*>(new OdDbImpAssocSweptSurfaceActionBody());
	else
		m_pImpObj = NULL;
}

OdDbAssocSweptSurfaceActionBody::~OdDbAssocSweptSurfaceActionBody()
{
