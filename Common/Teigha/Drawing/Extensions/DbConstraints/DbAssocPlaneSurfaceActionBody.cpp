...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ODRX_DEFINE_MEMBERS_EX(OdDbAssocPlaneSurfaceActionBody,      // ClassName
	...
	1025,                          // nProxyFlags 
	L"AcDbAssocPlaneSurfaceActionBody",   // DWG class name
	L"ACDBASSOCPLANESURFACEACTIONBODY",   // DxfName
										  //L"ACDBASSOCROTATEDDIMACTIONBODY",   // DWG class name
	L"ObjectDBX Classes",         // AppName
	OdRx::kMTLoading | OdRx::kHistoryAware);

OdDbAssocPlaneSurfaceActionBody::OdDbAssocPlaneSurfaceActionBody(bool bCreateImpl)
{
	if (bCreateImpl)
		m_pImpObj = static_cast<OdDbImpAssocActionBody*>(new OdDbImpAssocPlaneSurfaceActionBody());
	else
		m_pImpObj = NULL;
}

OdDbAssocPlaneSurfaceActionBody::~OdDbAssocPlaneSurfaceActionBody()
{
