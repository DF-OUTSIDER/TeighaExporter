...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ODRX_DEFINE_MEMBERS_EX(OdDbAssocRevolvedSurfaceActionBody,      // ClassName
	...
	1025,                          // nProxyFlags 
	L"AcDbAssocRevolvedSurfaceActionBody",   // DWG class name
	L"ACDBASSOCREVOLVEDSURFACEACTIONBODY",   // DxfName
										  //L"ACDBASSOCROTATEDDIMACTIONBODY",   // DWG class name
	L"ObjectDBX Classes",         // AppName
	OdRx::kMTLoading | OdRx::kHistoryAware);

OdDbAssocRevolvedSurfaceActionBody::OdDbAssocRevolvedSurfaceActionBody(bool bCreateImpl)
{
	if (bCreateImpl)
		m_pImpObj = static_cast<OdDbImpAssocActionBody*>(new OdDbImpAssocRevolvedSurfaceActionBody());
	else
		m_pImpObj = NULL;
}

OdDbAssocRevolvedSurfaceActionBody::~OdDbAssocRevolvedSurfaceActionBody()
{
