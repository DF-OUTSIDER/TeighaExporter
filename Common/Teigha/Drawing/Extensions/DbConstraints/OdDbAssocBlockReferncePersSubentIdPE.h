...
#ifndef OdDbAssocBlockReferncePersSubentIdPE_INCLUDED_
#define OdDbAssocBlockReferncePersSubentIdPE_INCLUDED_  /*!DOM*/
...
working with Block Refernce persistent subentity identifier.

Library: Source code provided.
<group Contraint_Classes>
*/
class DBCONSTRAINTS_EXPORT OdDbAssocBlockReferncePersSubentIdPE : public OdDbAssocPointBasedPersSubentIdPE
{
public:
  ODRX_DECLARE_MEMBERS(OdDbAssocBlockReferncePersSubentIdPE);
  ...
  */
  ...
  //OdResult getEdgeSubentityGeometry(const OdDbEntity*   pEntity,
  //  const OdDbSubentId& edgeSubentId,
...
typedef OdSmartPtr<OdDbAssocBlockReferncePersSubentIdPE> OdDbAssocBlockReferncePersSubentIdPEPtr;
