...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ODRX_DEFINE_MEMBERS_EX(OdDbAssocTrimSurfaceActionBody,      // ClassName
	OdDbAssocPathBasedSurfaceActionBody, // ParentClass
	DBOBJECT_CONSTR,               // DOCREATE
	OdDb::kDHL_1024,               // DwgVer
	OdDb::kMRelease25,              // MaintVer
	1025,                          // nProxyFlags 
	L"AcDbAssocTrimSurfaceActionBody",   // DWG class name
	L"ACDBASSOCTRIMSURFACEACTIONBODY",   // DxfName
	L"ObjectDBX Classes",         // AppName
	OdRx::kMTLoading | OdRx::kHistoryAware);

OdDbAssocTrimSurfaceActionBody::OdDbAssocTrimSurfaceActionBody(bool bCreateImpl)
{
	if (bCreateImpl)
		m_pImpObj = static_cast<OdDbImpAssocActionBody*>(new OdDbImpAssocTrimSurfaceActionBody());
	else
		m_pImpObj = NULL;
}

OdDbAssocTrimSurfaceActionBody::~OdDbAssocTrimSurfaceActionBody()
{
