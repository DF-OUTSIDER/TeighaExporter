...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ODRX_DEFINE_MEMBERS_EX(OdDbAssocExtrudedSurfaceActionBody,      // ClassName
	...
	1025,                          // nProxyFlags 
	L"AcDbAssocExtrudedSurfaceActionBody",   // DWG class name
	L"ACDBASSOCEXTRUDEDSURFACEACTIONBODY",   // DxfName
	L"ObjectDBX Classes",         // AppName
	OdRx::kMTLoading | OdRx::kHistoryAware);

OdDbAssocExtrudedSurfaceActionBody::OdDbAssocExtrudedSurfaceActionBody(bool bCreateImpl)
{
	if (bCreateImpl)
		m_pImpObj = static_cast<OdDbImpAssocActionBody*>(new OdDbImpAssocExtrudedSurfaceActionBody());
	else
		m_pImpObj = NULL;
}

OdDbAssocExtrudedSurfaceActionBody::~OdDbAssocExtrudedSurfaceActionBody()
{
