...
#ifndef OdDbAssocSurfacePersSubentIdPE_INCLUDED_
#define OdDbAssocSurfacePersSubentIdPE_INCLUDED_  /*!DOM*/
...
*/
class DBCONSTRAINTS_EXPORT OdDbAssocSurfacePersSubentIdPE : public OdDbAssocCurvePersSubentIdPE
{
public:
  ODRX_DECLARE_MEMBERS(OdDbAssocSurfacePersSubentIdPE);
...
typedef OdSmartPtr<OdDbAssocSurfacePersSubentIdPE> OdDbAssocSurfacePersSubentIdPEPtr;
