...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ODRX_DEFINE_MEMBERS_EX(OdDbAssocExtendSurfaceActionBody,      // ClassName
	OdDbAssocPathBasedSurfaceActionBody, // ParentClass
	DBOBJECT_CONSTR,               // DOCREATE
	OdDb::kDHL_1027,               // DwgVer
	OdDb::kMRelease125,              // MaintVer
	1025,                          // nProxyFlags 
	L"AcDbAssocExtendSurfaceActionBody",   // DWG class name
	L"ACDBASSOCEXTENDSURFACEACTIONBODY",   // DxfName
	L"ObjectDBX Classes",         // AppName
	OdRx::kMTLoading | OdRx::kHistoryAware);

OdDbAssocExtendSurfaceActionBody::OdDbAssocExtendSurfaceActionBody(bool bCreateImpl)
{
	if (bCreateImpl)
		m_pImpObj = static_cast<OdDbImpAssocActionBody*>(new OdDbImpAssocExtendSurfaceActionBody());
	else
		m_pImpObj = NULL;
}

OdDbAssocExtendSurfaceActionBody::~OdDbAssocExtendSurfaceActionBody()
{
