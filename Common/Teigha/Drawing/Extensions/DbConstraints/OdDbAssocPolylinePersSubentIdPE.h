...
#ifndef OdDbAssocPolylinePersSubentIdPE_INCLUDED_
#define OdDbAssocPolylinePersSubentIdPE_INCLUDED_  /*!DOM*/
...
*/
class DBCONSTRAINTS_EXPORT OdDbAssocPolylinePersSubentIdPE : public OdDbAssocCurvePersSubentIdPE
{
public:
  ODRX_DECLARE_MEMBERS(OdDbAssocPolylinePersSubentIdPE);
...
typedef OdSmartPtr<OdDbAssocPolylinePersSubentIdPE> OdDbAssocPolylinePersSubentIdPEPtr;
