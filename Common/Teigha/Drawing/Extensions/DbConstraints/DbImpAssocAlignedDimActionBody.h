...
///////////////////////////////////////////////////////////////////////////////
#ifndef DbImpAssocAlignedDimActionBody_INCLUDED_
#define DbImpAssocAlignedDimActionBody_INCLUDED_ /*!DOM*/
...
*/
class DBCONSTRAINTS_EXPORT OdDbImpAssocAlignedDimActionBody : public OdDbImpAssocAnnotationActionBody
{
public:
  /** \details
  Constructor creates an instance of this class.
  */
  OdDbImpAssocAlignedDimActionBody();

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdDbImpAssocAlignedDimActionBody();
  ...
  */
  ...
  /** \details
  Creates associative aligned dimension: action, action body, dependencies etc.
  */
