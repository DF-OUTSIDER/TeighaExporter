...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
ODRX_DEFINE_MEMBERS_EX(OdDbAssocFilletSurfaceActionBody,      // ClassName
	OdDbAssocSurfaceActionBody, // ParentClass
	DBOBJECT_CONSTR,               // DOCREATE
	OdDb::kDHL_1027,               // DwgVer
	OdDb::kMRelease125,              // MaintVer
	1025,                          // nProxyFlags 
	L"AcDbAssocFilletSurfaceActionBody",   // DWG class name
	L"ACDbASSOCFILLETSURFACEACTIONBODY",   // DxfName
	L"ObjectDBX Classes",         // AppName
	OdRx::kMTLoading | OdRx::kHistoryAware);

OdDbAssocFilletSurfaceActionBody::OdDbAssocFilletSurfaceActionBody(bool bCreateImpl)
{
	if (bCreateImpl)
		m_pImpObj = static_cast<OdDbImpAssocActionBody*>(new OdDbImpAssocFilletSurfaceActionBody());
	else
		m_pImpObj = NULL;
}

OdDbAssocFilletSurfaceActionBody::~OdDbAssocFilletSurfaceActionBody()
{
