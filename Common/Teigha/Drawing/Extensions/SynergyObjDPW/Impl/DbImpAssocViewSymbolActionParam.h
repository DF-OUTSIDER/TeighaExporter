...
#ifndef DbImpAssocViewSymbolActionParam_INCLUDED_
#define DbImpAssocViewSymbolActionParam_INCLUDED_ /*!DOM*/
...
/** \details
  This class implements the view symbol action parameter.

  Library: Source code provided.
  <group Contraint_Classes> 
*/
class SYNERGYOBJDPW_EXPORT OdDbImpAssocViewSymbolActionParam : public OdDbImpAssocObjectActionParam
{
public:     
  /** \details
    Constructor creates an instance of this class.
  */
  OdDbImpAssocViewSymbolActionParam();

  /** \details
    Destructor destroys an instance of this class.
  */
  virtual ~OdDbImpAssocViewSymbolActionParam();
...
#endif // DbImpAssocViewSymbolActionParam_INCLUDED_
