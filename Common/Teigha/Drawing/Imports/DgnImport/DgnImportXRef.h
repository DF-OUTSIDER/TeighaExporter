...
#ifndef _DGN_IMPORT_XREF_INCLUDED_ 
#define _DGN_IMPORT_XREF_INCLUDED_
...
struct OdDgReferenceAttachmentImportPE : OdDgnImportPE
{
public:
...
#endif // _DGN_IMPORT_XREF_INCLUDED_
