...
///////////////////////////////////////////////////////////////////////////////
#ifndef _COLLADA_MATERIALIMPORTER_H_
#define _COLLADA_MATERIALIMPORTER_H_
...
namespace TD_COLLADA_IMPORT
{
  ...
  */
  ...
  public:
    ...
    */
    bool import(const COLLADAFW::Material* pMaterial);
  private:
...
#endif // _COLLADA_MATERIALIMPORTER_H_
