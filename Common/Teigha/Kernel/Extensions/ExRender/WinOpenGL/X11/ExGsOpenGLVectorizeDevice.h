...
protected:
  ...
  mutable ExGsXWindowConnection m_xConnection;
  GLXContext                    m_context;
  
  friend class ExGsOpenGLVectorizeView;

public:
  OdIntPtr getXDisplay() const;
  void setXDisplay(OdIntPtr dp);
  
  OdIntPtr getXWindow() const;
  void setXWindow(OdIntPtr win);
  
  OdIntPtr chooseVisual() const;
  void setChooseVisual(OdIntPtr vinfo);

  OdIntPtr getGLXContext() const;
  void setGLXContext(OdIntPtr ctx);
