...
// CreatorInfo dictionary (Optional)
// Language dictionary (Optional)
// Export dictionary (Optional)
// Zoom dictionary (Optional)
// Print dictionary (Optional)
_PDF_DICT_KEYS_A_(View             , PDFDictionary ) //(Optional)
// User dictionary (Optional)
// PageElement dictionary (Optional)
