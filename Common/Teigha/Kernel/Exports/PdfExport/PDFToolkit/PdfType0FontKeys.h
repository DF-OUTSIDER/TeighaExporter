...
_PDF_DICT_KEYS_A_    (Encoding        , PDFObject    ); // (Required) name or stream
_PDF_DICT_KEYS_A_    (DescendantFonts , PDFArray     ); // (Required)
_PDF_DICT_KEYS_A_    (ToUnicode       , PDFStream    ); // (Optional)
