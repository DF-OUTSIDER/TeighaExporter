...
///////////////////////////////////////////////////////////////////////////////
// JsonServer interface for GLES2(?) JSON device

#ifndef ODGLES2JSONSERVER
#define ODGLES2JSONSERVER

#include "TD_PackPush.h"

#include "Ge/GeMatrix3d.h"
#include "RxObject.h"
#include "Tr/TrVisIdMap.h"

class OdDbStub;
class OdTrVisUniqueID;
class OdGsFiler;
class OdGLES2JsonRendition;

/** \details
    <group ExRender_Windows_Classes> 
*/
class OdGLES2JsonServer : public OdRxObject
{
public:
  enum JsonType
  {
...
public:
  ...
  virtual void IncreaseNesting(const char* pLevelName, const OdGLES2JsonServer::JsonType &) = 0;
  virtual void DecreaseNesting(const char* pLevelName, const OdGLES2JsonServer::JsonType &) = 0;
  ...
  virtual bool DropMetafileAdded(OdGLES2JsonRendition& rndn, OdTrVisMetafileId& metafileId, const OdTrVisMetafileDef &pDef) { return false; }
  ...
  virtual void DropUInts(const char* pTagName, OdUInt32 nData, const OdUInt32* pData) = 0;
  ...
  virtual OdBool isEnableFaces() const = 0;
};

inline
void OdGLES2JsonServer::DropString(const char *pTagName, const OdString &pStr)
{
...
/** \details
    <group ExRender_Windows_Classes> 
*/
class OdGLES2JsonServerStub : public OdGLES2JsonServer
{
public:
  virtual void IncreaseNesting(const char* /*pLevelName*/,  const OdGLES2JsonServer::JsonType &) { }
  virtual void DecreaseNesting(const char* /*pLevelName*/,  const OdGLES2JsonServer::JsonType &) { }
