...
///////////////////////////////////////////////////////////////////////////////
// GLES2 device texture definition
...
struct OdTrVisTextureDef
{
  ...
  enum Flags
  {
    kSmoothFilter  = (1 << 0), // Enable bilinear texture filtration
    kModulateColor = (1 << 1)  // Enable texture color with vertex color modulation
  };
  // Texture flags
  OdUInt16 m_flags;
  // Texture
